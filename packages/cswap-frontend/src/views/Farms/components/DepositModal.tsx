...
import { Flex, Text, Button, Modal, LinkExternal, CalculateIcon, IconButton } from 'cswap-uikit'
...
const DepositModal: React.FC<DepositModalProps> = ({
  ...
  const interestBreakdown = getInterestBreakdown({
    ...
    apr,
    earningTokenPrice: cswapPrice.toNumber(),
  })

  const annualRoi = cswapPrice.times(interestBreakdown[3])
