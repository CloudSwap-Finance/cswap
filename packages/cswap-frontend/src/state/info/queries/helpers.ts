import { ONE_DAY_UNIX, CSWAP_FINANCE_START } from 'config/constants/info'
import { getUnixTime } from 'date-fns'
import { TransactionType } from 'state/info/types'
import { ChartEntry } from '../types'
import { MintResponse, SwapResponse, BurnResponse, TokenDayData, PairDayData, CswapDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | CswapDayData): ChartEntry => ({
...
export const fetchChartData = async (
  ...
  let timestamp = firstAvailableDayData?.date ?? CSWAP_FINANCE_START
