...
import { ChainId, JSBI, Percent, Token, CurrencyAmount, Currency, ETHER } from 'cswap-sdk'
...
// show cswapPrice
export function showCswapPrice(): boolean {
  return process.env.REACT_APP_SHOW_CSWAP_PRICE === 'true'
}
