...
export interface VaultUser {
  isLoading: boolean
  userShares: string
  cswapAtLastUserAction: string
  lastDepositedTime: string
  lastUserActionTime: string
}
export interface CswapVault {
  totalShares?: string
  pricePerFullShare?: string
  totalCswapInVault?: string
  estimatedCswapBountyReward?: string
  totalPendingCswapHarvest?: string
  fees?: VaultFees
  userData?: VaultUser
}
