...
import { LinkExternal, Text } from 'cswap-uikit'
...
import CswapAllocation, { AllocationProps } from '../CswapAllocation'
  ...
  return (
    <Container expanded={expanded} background="#F4F5F1">
      ...
      <ValueContainer>
        {isBlindMode() ? (
          <ValueWrapper>
            <Text color="textSubtle">{t('CSWAP Allocation')}</Text>
            <CswapAllocation {...allocation} />
          </ValueWrapper>
        ) : (<ValueWrapper>
