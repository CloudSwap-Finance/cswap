...
export const CSWAP_PER_BLOCK = Number(process.env.REACT_APP_CSWAP_PER_BLOCK) // FIXME cswap per block
export const BLOCKS_PER_YEAR = (60 / CRONOS_BLOCK_TIME) * 60 * 24 * 365 // 10512000
export const CSWAP_PER_YEAR = CSWAP_PER_BLOCK * BLOCKS_PER_YEAR // FIXME cswap block per year
