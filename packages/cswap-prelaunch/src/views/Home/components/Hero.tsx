...
import { Flex, Link, Text, useMatchBreakpoints } from 'cswap-uikit'
    ...
    <>
      ...
      <HeroContainer position="relative" justifyContent="center" id="homepage-hero" minHeight="358px">
        <Flex flex="1" flexDirection="column" maxWidth="512px" mt={["40px", "40px", "40px", "80px"]}>
          <StyledBigHeading>Cloud Swap, Decentralized Finance for all<Badge>
          ...
          <Text {...titleStyleProps} color="white">
            Your gateway to the decentralized finance movement. Take control of your finances and earn sparkly CSWAP
            rewards.
          </Text>
          <Text {...titleStyleProps} color="white">
            <Link color="rgb(70, 161, 194)" mr="5px" href="https://medium.com/cswap-finance/cswap-finance-very-very-simple-defi-for-everyone-8c864be68b6a" display="inline-block" {...titleStyleProps}>
              Learn more
            </Link>
            about CSWAP Finance.
          </Text>
