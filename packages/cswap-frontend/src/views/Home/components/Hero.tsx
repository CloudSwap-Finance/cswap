...
import { Flex, Image, Link, Button, Text, useMatchBreakpoints } from 'cswap-uikit'
    ...
    <>
      ...
      <HeroContainer position="relative" justifyContent="center" id="homepage-hero" minHeight="358px">
        <Flex flex="1" flexDirection="column" maxWidth="512px" mt={["40px", "40px", "40px", "80px"]}>
          <StyledBigHeading>Cloud Swap, Decentralized Finance for all</StyledBigHeading>
          ...
          <Text {...titleStyleProps} color="white">
            <Link mr="5px" href="https://docs.cswap.finance" target="_blank" display="inline-block" {...titleStyleProps}>
              Learn more
            </Link>
            about CSWAP Finance.
          </Text>
