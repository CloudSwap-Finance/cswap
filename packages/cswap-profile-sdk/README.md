...
It also sets `profile_${address}` cookie containing username and avatar (now only for cswap.finance domain, maybe configurable in future versions)

```js
import PancakeProfileSdk from "@cswap-swap/profile-sdk";
