...
import CswapPrice from "../../components/CswapPrice/CswapPrice";
...
const Menu: React.FC<NavProps> = ({
  ...
  const TooltipComponent = () => (
    <>
      ...
      <Text mb="16px">{t("Welcome! You are a pioneer in the CSWAP mines! In this mode, APR calculation, analytics, and USD values will not be shown during the initial launch week as prices and historical data points are still forming.")}</Text>
      <Text>
    ...
    <Wrapper>
      <StyledNav showMenu={showMenu}>
        ...
        <Flex alignItems="center">
          ...
          {!isMobile && !!showCswapPrice && !isBlindMode && (
            <Box mr="12px">
              <CswapPrice cswapPriceUsd={cswapPriceUsd} cswapAddress={cswapAddress} iconCallback={iconCallback} />
            </Box>
          )}
          {/* <Box mt="4px">
            <LangSelector
      ...
      <BodyWrapper>
        <Inner isPushed={false} showMenu={showMenu}>
          ...
          {/* <Footer
            ...
            setLang={setLang}
            currentLang={currentLang}
            cswapPriceUsd={cswapPriceUsd}
            buyCswapLabel={buyCswapLabel}
