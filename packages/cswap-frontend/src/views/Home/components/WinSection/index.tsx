...
import { Flex, Text, TicketFillIcon, PredictionsIcon } from 'cswap-uikit'
...
const bottomLeftImage = {
  ...
  attributes: [
    { src: 'bottom-left', alt: 'CSWAP card' },
    { src: 'green', alt: 'Green CSWAP card with up arrow' },
    { src: 'red', alt: 'Red CSWAP card with down arrow' },
    { src: 'top-right', alt: 'CSWAP card' },
  ],
}
