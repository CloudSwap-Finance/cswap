...
import cswapAbi from 'config/abi/cswap.json'
...
export const getCswapContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(cswapAbi, tokens.cswap.address, signer)
}
...
export const getCswapVaultContract = (signer?: ethers.Signer | ethers.providers.Provider) => {
  return getContract(cswapVaultAbi, getCswapVaultAddress(), signer)
}
