import { ChainId, Currency, currencyEquals, JSBI, Price } from 'cswap-sdk'
...
export const useCswapUsdcPrice = (): Price | undefined => {
  const cswapUsdcPrice = useUsdcPrice(tokens.cswap)
  return cswapUsdcPrice
}
